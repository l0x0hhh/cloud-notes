...
export function AppShell() {
  ...
  return (
    <header className="sticky top-0 z-40 px-4 pt-3 pb-0">
      <div className="card card-sm mx-auto max-w-7xl px-5 py-2.5 flex items-center justify-between gap-4">
        <div className="flex items-center gap-2.5 shrink-0">
          <div className="p-1.5 rounded-xl bg-brand/15 text-brand">
            <FileText className="w-4 h-4" />
          </div>
          <span className="text-sm font-semibold text-linear tracking-tight font-display">
            Cloud Notes
          </span>
        </div>
